...
# The names need to be spliced (in this case by the first five letters), otherwise it causes issues with the file names
# in subsequent steps. If the names are not spliced, the file name would be, for example, Lakes.shp_buffer.img and this
...
# As before, the names are spliced by the first five letters to avoid issues wih the file names in subsequent steps.
