...
with open(r"C:\Data\Coding_Challenge_5\Seal_Data\Harbor_Gray_Seal_Data.csv") as seal_csv:
...
# Create the fishnet from the shapefile and name it
    ...
    outFeatureClass = seal[0:2] + "_fishnet.shp"
...
# Create the heatmap by joining the shapefile and the fishnet, some parameters can be left blank
    target_features = seal[0:2] + "_fishnet.shp"
    join_features = seal[0:2] + ".shp"
    out_feature_class = seal[0:2] + "heatmap.shp"
